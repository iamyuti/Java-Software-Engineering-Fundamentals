...
public class DinosaurDNA {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DinosaurDNA ObjDNA) {
            return this.geneticCode == ObjDNA.geneticCode;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        result.append("DNA: ").append(Integer.toBinaryString(geneticCode)).append(" (").append(geneticCode).append(")");

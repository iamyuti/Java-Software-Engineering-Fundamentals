...
public class AdvancedLinePrinter {
    ...
    */
    ...
    public void printCharacter(char character) {
        char[][] brailleSym = font.getBitmap(character);
        lineBuffer.push(brailleSym);
    }
     ...
     */
    public void flush() {
        String[] rendered = lineBuffer.renderScanlines(spacing);
    ...
    public void insertCharacter(int position, char character) {
        char[][] brailleSym = font.getBitmap(character);
        lineBuffer.insert(position, brailleSym);
    }

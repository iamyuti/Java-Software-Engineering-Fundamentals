...
public class BJDealer implements Dealer {
    ...
    public Card dealCard() throws BadDeckException {
        ...
        try {
            ...
            try {
                return this.deck.drawCard();
            } catch (OutOfCardsException d) {
                throw new BadDeckException("Out of cards", d.getCause());
            }
        }
    }
    ...
    public int playAction(Hand dealerHand) throws BadDeckException {
        // TODO: implementation
        if (dealerHand.getScore() == 100) {
            return dealerHand.getScore();
        }
        while (dealerHand.getScore() <= 16 && dealerHand.getScore() != 0) {
